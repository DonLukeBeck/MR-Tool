        ...
        # Remove steps if the server incorporates a dialogue agent
            ...
            try:
                ...
                if step_number == 1:
                    ...
                    sock.SendData("Step 4: Grab the second black 2x2 plate with wheel holders and place it on the table")
                elif step_number == 5:
                    ...
                    sock.SendData("Step 7: Insert the 2x4 yellow plate on top of one of the black plates and leave a "
                                  "1x2 space on the other black plate")
                elif step_number == 8:
